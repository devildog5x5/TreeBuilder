...
Begin VB.Form frmOptions 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(0).Control(15)=   "LabelStart"
      Tab(0).Control(15).Enabled=   0   'False
      Tab(0).Control(16)=   "CmdViewICE"
      Tab(0).Control(16).Enabled=   0   'False
      Tab(0).Control(17)=   "QS"
      Tab(0).Control(17).Enabled=   0   'False
      Tab(0).Control(18)=   "Text31"
      Tab(0).Control(18).Enabled=   0   'False
      Tab(0).Control(19)=   "CustomCheck"
      Tab(0).Control(19).Enabled=   0   'False
      Tab(0).Control(20)=   "Text30"
      Tab(0).Control(20).Enabled=   0   'False
      Tab(0).Control(21)=   "CmdBrowse10"
      Tab(0).Control(21).Enabled=   0   'False
      Tab(0).Control(22)=   "cmdViewCust"
      Tab(0).Control(22).Enabled=   0   'False
      Tab(0).Control(23)=   "cmdClean"
      Tab(0).Control(23).Enabled=   0   'False
      Tab(0).Control(24)=   "cmdViewRice"
      Tab(0).Control(24).Enabled=   0   'False
      Tab(0).Control(25)=   "CmdBrowse5"
      Tab(0).Control(25).Enabled=   0   'False
      Tab(0).Control(26)=   "Text19"
      Tab(0).Control(26).Enabled=   0   'False
      Tab(0).Control(27)=   "Combo1"
      Tab(0).Control(27).Enabled=   0   'False
      Tab(0).Control(28)=   "CheckDel"
      Tab(0).Control(28).Enabled=   0   'False
      Tab(0).Control(29)=   "cmdViewImp"
      Tab(0).Control(29).Enabled=   0   'False
      Tab(0).Control(30)=   "cmdViewExp"
      Tab(0).Control(30).Enabled=   0   'False
      Tab(0).Control(31)=   "AnonCheck"
      Tab(0).Control(31).Enabled=   0   'False
      Tab(0).Control(32)=   "Text14"
      Tab(0).Control(32).Enabled=   0   'False
      Tab(0).Control(33)=   "UserHomeCheck"
      Tab(0).Control(33).Enabled=   0   'False
      Tab(0).Control(34)=   "CmdBrowse4"
      Tab(0).Control(34).Enabled=   0   'False
      Tab(0).Control(35)=   "Text7"
      Tab(0).Control(35).Enabled=   0   'False
      Tab(0).Control(36)=   "CheckAdd"
      Tab(0).Control(36).Enabled=   0   'False
      Tab(0).Control(37)=   "RetrieveTreeCheck"
      Tab(0).Control(37).Enabled=   0   'False
      Tab(0).Control(38)=   "CmdBrowse3"
      Tab(0).Control(38).Enabled=   0   'False
      Tab(0).Control(39)=   "Text6"
      Tab(0).Control(39).Enabled=   0   'False
      Tab(0).Control(40)=   "Combo6"
      Tab(0).Control(40).Enabled=   0   'False
      Tab(0).Control(41)=   "Combo2"
      Tab(0).Control(41).Enabled=   0   'False
      Tab(0).Control(42)=   "Text1"
      Tab(0).Control(42).Enabled=   0   'False
      Tab(0).Control(43)=   "Text2"
      Tab(0).Control(43).Enabled=   0   'False
      Tab(0).Control(44)=   "Text3"
      Tab(0).Control(44).Enabled=   0   'False
      Tab(0).Control(45)=   "Text4"
      Tab(0).Control(45).Enabled=   0   'False
      Tab(0).Control(46)=   "Text5"
      Tab(0).Control(46).Enabled=   0   'False
      Tab(0).Control(47)=   "CmdBrowse1"
      Tab(0).Control(47).Enabled=   0   'False
      Tab(0).Control(48)=   "CmdBrowse2"
      Tab(0).Control(48).Enabled=   0   'False
      Tab(0).Control(49)=   "StopOnErrCheck"
      Tab(0).Control(49).Enabled=   0   'False
      Tab(0).Control(50)=   "Text32"
      Tab(0).Control(50).Enabled=   0   'False
      Tab(0).Control(51)=   "CfgBrowse"
      Tab(0).Control(51).Enabled=   0   'False
      Tab(0).Control(52)=   "CheckWriteOnly"
      Tab(0).Control(52).Enabled=   0   'False
      Tab(0).Control(53)=   "CheckModify"
      Tab(0).Control(53).Enabled=   0   'False
      Tab(0).Control(54)=   "TextFileImport"
      Tab(0).Control(54).Enabled=   0   'False
      Tab(0).Control(55)=   "SNum"
      Tab(0).Control(55).Enabled=   0   'False
      Tab(0).Control(56)=   "SimpleCheck"
      Tab(0).Control(56).Enabled=   0   'False
      Tab(0).ControlCount=   57
      TabCaption(1)   =   "User Configuration"
      TabPicture(1)   =   "frmOptions1.frx":08E6
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "Text44"
      Tab(1).Control(1)=   "Text43"
      Tab(1).Control(2)=   "Text42"
      Tab(1).Control(3)=   "Text41"
      Tab(1).Control(4)=   "Text40"
      Tab(1).Control(5)=   "Text39"
      Tab(1).Control(6)=   "Text38"
      Tab(1).Control(7)=   "Text37"
      Tab(1).Control(8)=   "Text36"
      Tab(1).Control(9)=   "Text35"
      Tab(1).Control(10)=   "Text34"
      Tab(1).Control(11)=   "Text33"
      Tab(1).Control(12)=   "AppDomCheck1"
      Tab(1).Control(13)=   "NoPwdChk4"
      Tab(1).Control(14)=   "NoPwdChk3"
      Tab(1).Control(15)=   "NoPwdChk2"
      Tab(1).Control(16)=   "NoPwdChk1"
      Tab(1).Control(17)=   "Text9"
      Tab(1).Control(18)=   "Text8"
      Tab(1).Control(19)=   "Combo14"
      Tab(1).Control(20)=   "Text28"
      Tab(1).Control(21)=   "Text25"
      Tab(1).Control(22)=   "Text26"
      Tab(1).Control(23)=   "Text27"
      Tab(1).Control(24)=   "Text23"
      Tab(1).Control(25)=   "Text20"
      Tab(1).Control(26)=   "Text21"
      Tab(1).Control(27)=   "Text22"
      Tab(1).Control(28)=   "Text18"
      Tab(1).Control(29)=   "Text15"
      Tab(1).Control(30)=   "Text16"
      Tab(1).Control(31)=   "Text17"
      Tab(1).Control(32)=   "Text13"
      Tab(1).Control(33)=   "Text12"
      Tab(1).Control(34)=   "Text11"
      Tab(1).Control(35)=   "Text10"
      Tab(1).Control(36)=   "UserSetOneCheck"
      Tab(1).Control(37)=   "UserSetTwoCheck"
      Tab(1).Control(38)=   "UserSetThreeCheck"
      Tab(1).Control(39)=   "UserSetFourCheck"
      Tab(1).Control(40)=   "SelectAllUserSetCheck"
      Tab(1).Control(41)=   "Text29"
      Tab(1).Control(42)=   "CustContCheck"
      Tab(1).Control(43)=   "Label26"
      Tab(1).Control(44)=   "Label24"
      Tab(1).Control(45)=   "Label18"
      Tab(1).Control(46)=   "Label31"
      Tab(1).Control(47)=   "Label29"
      Tab(1).Control(48)=   "Label27"
      Tab(1).Control(49)=   "Label25"
      Tab(1).Control(50)=   "Label20"
      Tab(1).Control(51)=   "Label15"
      Tab(1).Control(52)=   "Label4"
      Tab(1).Control(53)=   "Label100"
      Tab(1).Control(54)=   "Label101"
      Tab(1).Control(55)=   "Label3"
      Tab(1).Control(56)=   "Label1"
      Tab(1).Control(57)=   "Label2"
      ...
      Tab(2).Control(44)=   "SkipTreeCreateCheck"
      ...
      Begin VB.CheckBox SimpleCheck 
         Caption         =   "Simple Password(s)"
         Height          =   255
         Left            =   4800
         TabIndex        =   185
      ...
      Begin VB.TextBox SNum 
         ...
         TabIndex        =   184
         Text            =   "1"
         ToolTipText     =   "This number must equal to or lower than the end number"
         Top             =   1800
         Width           =   975
      End
      Begin VB.CommandButton TextFileImport 
         Caption         =   "File Import"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
         ...
         Left            =   8160
         TabIndex        =   182
         ToolTipText     =   "Use a comma delimited text file to build LDIF files."
         Top             =   480
         Width           =   1335
      End
      ...
      Begin VB.CheckBox AppDomCheck1 
         ...
         Left            =   -67440
         TabIndex        =   163
         ToolTipText     =   $"frmOptions1.frx":09E8
         Top             =   6720
         Width           =   2055
      End
      Begin VB.CheckBox NoPwdChk4 
         ...
         Left            =   -67200
         TabIndex        =   162
         ToolTipText     =   $"frmOptions1.frx":0A9D
         Top             =   3840
         Width           =   1695
      End
      Begin VB.CheckBox NoPwdChk3 
         ...
         Left            =   -69360
         TabIndex        =   161
         ToolTipText     =   $"frmOptions1.frx":0B71
         Top             =   3840
         Width           =   1695
      End
      Begin VB.CheckBox NoPwdChk2 
         ...
         Left            =   -71520
         TabIndex        =   160
         ToolTipText     =   $"frmOptions1.frx":0C45
         Top             =   3840
         Width           =   1695
      End
      Begin VB.CheckBox NoPwdChk1 
         ...
         Left            =   -73680
         TabIndex        =   159
         ToolTipText     =   $"frmOptions1.frx":0D19
         Top             =   3840
         Width           =   1695
      End
      ...
      Begin VB.CommandButton CmdBrowse1 
         ...
         Left            =   4440
         TabIndex        =   115
         ToolTipText     =   $"frmOptions1.frx":0DED
         Top             =   2040
         Width           =   1335
      End
      ...
      Begin VB.ComboBox Combo2 
         Height          =   315
         ItemData        =   "frmOptions1.frx":0E97
         Left            =   8520
         List            =   "frmOptions1.frx":0EB0
         Style           =   1  'Simple Combo
         TabIndex        =   109
         Text            =   "1"
         ToolTipText     =   "This number must equal to or higher than the start number"
         Top             =   2160
         Width           =   975
      End
      ...
      Begin VB.TextBox Text8 
         ...
         Left            =   -72840
         TabIndex        =   107
         Text            =   "mh.ldschurch.org"
         Top             =   6720
         Width           =   1575
      End
      Begin VB.ComboBox Combo14 
         Height          =   315
         ItemData        =   "frmOptions1.frx":0EE5
         Left            =   -71520
         List            =   "frmOptions1.frx":0EEF
         TabIndex        =   106
         Text            =   "No"
      ...
      Begin VB.TextBox Text403 
         ...
         TabIndex        =   88
         Text            =   "C:\Users\"
         ToolTipText     =   $"frmOptions1.frx":0EFC
         Top             =   1560
         Width           =   2895
      End
      Begin VB.TextBox Text401 
         ...
         ToolTipText     =   $"frmOptions1.frx":0FB8
         Top             =   1080
         Width           =   6735
      End
      Begin VB.ComboBox Combo199 
         Height          =   315
         ItemData        =   "frmOptions1.frx":107E
         Left            =   -71760
         List            =   "frmOptions1.frx":135B
         TabIndex        =   86
         Text            =   "US"
         Top             =   960
         Width           =   735
      ...
      Begin VB.ComboBox Combo6 
         Height          =   315
         ItemData        =   "frmOptions1.frx":172B
         Left            =   8520
         List            =   "frmOptions1.frx":1735
         TabIndex        =   85
         Text            =   "NDS 8"
         ToolTipText     =   "Select the version of NDS"
         Top             =   2520
         Width           =   975
      End
      ...
      Begin VB.ComboBox Combo104 
         Height          =   315
         ItemData        =   "frmOptions1.frx":1747
         Left            =   -74640
         List            =   "frmOptions1.frx":179F
         Style           =   1  'Simple Combo
         TabIndex        =   73
         Text            =   "Level4Users"
         Top             =   3840
      ...
      Begin VB.ComboBox Combo105 
         Height          =   315
         ItemData        =   "frmOptions1.frx":18DD
         Left            =   -74640
         List            =   "frmOptions1.frx":1935
         Style           =   1  'Simple Combo
         TabIndex        =   72
         Text            =   "Level5Users"
         Top             =   4320
      ...
      Begin VB.ComboBox Combo106 
         Height          =   315
         ItemData        =   "frmOptions1.frx":1A73
         Left            =   -74640
         List            =   "frmOptions1.frx":1ACB
         Style           =   1  'Simple Combo
         TabIndex        =   71
         Text            =   "Level6Users"
         Top             =   4800
      ...
      Begin VB.ComboBox Combo204 
         Height          =   315
         ItemData        =   "frmOptions1.frx":1C09
         Left            =   -73080
         List            =   "frmOptions1.frx":1C61
         Style           =   1  'Simple Combo
         TabIndex        =   70
         Text            =   "Level4Users"
         Top             =   3840
      ...
      Begin VB.ComboBox Combo205 
         Height          =   315
         ItemData        =   "frmOptions1.frx":1D9F
         Left            =   -73080
         List            =   "frmOptions1.frx":1DF7
         Style           =   1  'Simple Combo
         TabIndex        =   69
         Text            =   "Level5Users"
         Top             =   4320
      ...
      Begin VB.ComboBox Combo206 
         Height          =   315
         ItemData        =   "frmOptions1.frx":1F35
         Left            =   -73080
         List            =   "frmOptions1.frx":1F8D
         Style           =   1  'Simple Combo
         TabIndex        =   68
         Text            =   "Level6Users"
         Top             =   4800
      ...
      Begin VB.ComboBox Combo304 
         Height          =   315
         ItemData        =   "frmOptions1.frx":20CB
         Left            =   -71520
         List            =   "frmOptions1.frx":2123
         Style           =   1  'Simple Combo
         TabIndex        =   67
         Text            =   "Level4Users"
         Top             =   3840
      ...
      Begin VB.ComboBox Combo305 
         Height          =   315
         ItemData        =   "frmOptions1.frx":2261
         Left            =   -71520
         List            =   "frmOptions1.frx":22B9
         Style           =   1  'Simple Combo
         TabIndex        =   66
         Text            =   "Level5Users"
         Top             =   4320
      ...
      Begin VB.ComboBox Combo306 
         Height          =   315
         ItemData        =   "frmOptions1.frx":23F7
         Left            =   -71520
         List            =   "frmOptions1.frx":244F
         Style           =   1  'Simple Combo
         TabIndex        =   65
         Text            =   "Level6Users"
         Top             =   4800
      ...
      Begin VB.ComboBox Combo404 
         Height          =   315
         ItemData        =   "frmOptions1.frx":258D
         Left            =   -69960
         List            =   "frmOptions1.frx":25E5
         Style           =   1  'Simple Combo
         TabIndex        =   64
         Text            =   "Level4Users"
         Top             =   3840
      ...
      Begin VB.ComboBox Combo405 
         Height          =   315
         ItemData        =   "frmOptions1.frx":2723
         Left            =   -69960
         List            =   "frmOptions1.frx":277B
         Style           =   1  'Simple Combo
         TabIndex        =   63
         Text            =   "Level5Users"
         Top             =   4320
      ...
      Begin VB.ComboBox Combo406 
         Height          =   315
         ItemData        =   "frmOptions1.frx":28B9
         Left            =   -69960
         List            =   "frmOptions1.frx":2911
         Style           =   1  'Simple Combo
         TabIndex        =   62
         Text            =   "Level6Users"
         Top             =   4800
      ...
      Begin VB.ComboBox Combo504 
         Height          =   315
         ItemData        =   "frmOptions1.frx":2A4F
         Left            =   -68400
         List            =   "frmOptions1.frx":2AA7
         Style           =   1  'Simple Combo
         TabIndex        =   61
         Text            =   "Level4Users"
         Top             =   3840
      ...
      Begin VB.ComboBox Combo505 
         Height          =   315
         ItemData        =   "frmOptions1.frx":2BE5
         Left            =   -68400
         List            =   "frmOptions1.frx":2C3D
         Style           =   1  'Simple Combo
         TabIndex        =   60
         Text            =   "Level5Users"
         Top             =   4320
      ...
      Begin VB.ComboBox Combo506 
         Height          =   315
         ItemData        =   "frmOptions1.frx":2D7B
         Left            =   -68400
         List            =   "frmOptions1.frx":2DD3
         Style           =   1  'Simple Combo
         TabIndex        =   59
         Text            =   "Level6Users"
         Top             =   4800
      ...
      Begin VB.ComboBox Combo604 
         Height          =   315
         ItemData        =   "frmOptions1.frx":2F11
         Left            =   -66840
         List            =   "frmOptions1.frx":2F69
         Style           =   1  'Simple Combo
         TabIndex        =   58
      ...
      Begin VB.ComboBox Combo605 
         Height          =   315
         ItemData        =   "frmOptions1.frx":30A7
         Left            =   -66840
         List            =   "frmOptions1.frx":30FF
         Style           =   1  'Simple Combo
         TabIndex        =   57
      ...
      Begin VB.ComboBox Combo606 
         Height          =   315
         ItemData        =   "frmOptions1.frx":323D
         Left            =   -66840
         List            =   "frmOptions1.frx":3295
         Style           =   1  'Simple Combo
         TabIndex        =   56
      ...
      Begin VB.TextBox Text14 
         ...
         TabIndex        =   55
         Text            =   "o=ldschurch"
         ToolTipText     =   "Typically the Organizational container or Root (o=Organization or t=Tree_Name). Default ""o=Novell"""
         Top             =   1440
         Width           =   1695
      End
      ...
      Begin VB.ComboBox Combo1 
         Height          =   315
         ItemData        =   "frmOptions1.frx":33D3
         Left            =   3240
         List            =   "frmOptions1.frx":33D5
         Style           =   1  'Simple Combo
         TabIndex        =   49
         Text            =   "389"
      ...
      Begin VB.TextBox Text405 
         ...
         TabIndex        =   28
         Text            =   "index.html"
         ToolTipText     =   $"frmOptions1.frx":33D7
         Top             =   2520
         Width           =   2895
      End
      Begin VB.TextBox Text19 
         ...
         TabIndex        =   27
         Text            =   "C:\Temp\"
         ToolTipText     =   $"frmOptions1.frx":3494
         Top             =   5040
         Width           =   3255
      End
      ...
      Begin VB.TextBox Text29 
         ...
         ToolTipText     =   $"frmOptions1.frx":3537
         Top             =   4560
         Width           =   6015
      End
      ...
      Begin VB.CheckBox CustomCheck 
         ...
         Left            =   240
         TabIndex        =   17
         ToolTipText     =   $"frmOptions1.frx":35C2
         Top             =   5520
         Width           =   2655
      End
...
RetVal = ShellExecute(0, "open", "iexplore", "http://internalwebserver/TreeBuilder/TreeBuilderReadme.html", "", SW_SHOW)
End Sub
...
Private Sub TextFileImport_Click()
ConversionTool.Show 0
End Sub
...
On Error GoTo ErrorHandler
   ...
   AnonCheck = 0
   RetrieveTreeCheck = 0
   Text2.Text = "cn=admin,o=LDSChurch"
   Text3.Text = "test"
   Text14.Text = "o=LDSChurch"
   Text31.Text = "sub"
   Combo2.Text = "1"
   Combo6.Text = "NDS 8"
   CheckAdd = 1
   ...
   CustContCheck = 0
   AppDomCheck1 = 0
   Text29.Text = ",ou=Provo,o=LDSChurch"
   Text32.Text = "C:\temp\TreeBuilder.conf"
   SkipTreeCreateCheck = 0
   Text100.Text = "Users"
   Text101.Text = "Engineering"
   Text102.Text = "Provo"
   Text103.Text = "LDSChurch"
   Text104.Text = "Users"
   Text105.Text = "Accounting"
   Text106.Text = "Boston"
   Text107.Text = "LDSChurch"
   Text108.Text = "Users"
   Text109.Text = "ProtocolEngineering"
   Text110.Text = "Bangalore"
   Text111.Text = "LDSChurch"
   Text112.Text = "Users"
   Text113.Text = "Internationalization"
   Text114.Text = "Dublin"
   Text115.Text = "LDSChurch"
   Text8.Text = "mh.LDSChurch.com"
   Text9.Text = "LDSChurch.com"
   Combo199.Text = ""
   Text200.Text = "LDSChurch"
...
If AnonCheck = 0 Then Text2.Text = "cn=admin,o=LDSChurch"
If AnonCheck = 0 Then Text3.Text = "test"
If AnonCheck = 0 Then Text4.Text = "Rootcert.der"
If AnonCheck = 0 Then Text14.Text = "o=LDSChurch"
...
If CustomCheck = 1 Then GoTo CustLDIFStep1 'If Custom LDIF file is selected bypass the file creation.
   ...
   Open FileOut For Output As #1 'File Open
      ...
      Print #1, "#This file generated by LDSChurch's Tree Builder Version 3.3 (Written by: Robert Foster)" 'File Header
      Print #1, "version: 1"
...
'End Delete Tree Information
 ...
 If CheckModify = 1 Then GoTo JumpExe
        'If CustomCheck = 1 Then MyVar = MsgBox("Server Update is about to start.", 0, "Update Starting!")
    If CustomCheck = 1 Then GoTo JMsg
...
Srch = Text31.Text + " "
RtCrt_Sw = "-L" + " "
If Text4.Text = "RtCert.der" Then RtCrt = ""
'RtCrt = Text4.Text + " "
F_Sw = "-f" + " "
FOut = Text6.Text + " "
FIn = Text7.Text + " "
...
If StopOnErrCheck = 0 Then Print #2, Sice + Source_Sw + LDIF_Sw + F_Sw + FOut + StopOnErr + Destination_Sw + LDAP_Sw + IP_Sw + IP + Prt_Sw + Prt + Uname_Sw + Uname + Pwd_Sw + Pwd + RtCrt_Sw + RtCrt + SPChk
If StopOnErrCheck = 1 Then Print #2, Sice + Source_Sw + LDIF_Sw + F_Sw + FOut + Destination_Sw + LDAP_Sw + IP_Sw + IP + Prt_Sw + Prt + Uname_Sw + Uname + Pwd_Sw + Pwd + RtCrt_Sw + RtCrt + SPChk
